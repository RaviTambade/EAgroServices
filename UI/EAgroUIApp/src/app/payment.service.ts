...
import { TransporterPayment } from './transporter-payment';
...
export class PaymentService {
  ...
  addFarmerServicepayment(farmerServicePayment: FarmerServicePayment): Observable<boolean> {
  ...
  addTransporterPayment(transporterPayment: TransporterPayment): Observable<boolean> {
