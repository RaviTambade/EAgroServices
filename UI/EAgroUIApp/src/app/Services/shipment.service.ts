...
export class ShipmentService {
  ...
  getShippedCollections(filterRequest: FilterRequest, pageNumber: number, staus: string): Observable<HttpResponse<ShippedCollection[]>> {
    ...
    return this.http.post<ShippedCollection[]>(url, filterRequest, { params: params, observe: 'response' });
  }
